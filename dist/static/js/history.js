...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_history__ = __webpack_require__(187);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    history: __WEBPACK_IMPORTED_MODULE_2__components_history__["a" /* default */]
  },
  methods: {
    getHistory: function getHistory() {
      ...
      if (typeof this.pageSum === 'undefined' || this.page <= this.pageSum) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_API__["l" /* GetHistory */])(this.page).then(function (res) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["d" /* hideLoading */])();
          _this.page++;
          _this.pageSum = res.data.pageSum;
          _this.parseHistory(res.data.groups).forEach(function (item) {
    ...
    parseHistory: function parseHistory(data) {
      return data.map(function (item) {
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, item, {
          hasFinished: !(item.unfinishedDay > 0),
          endTime: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_utils__["a" /* normalizeTimeHours */])(item.endTime),
    ...
    getTaskMoreInfo: function getTaskMoreInfo(key, formId) {
      console.log(formId);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_API__["f" /* SubmitForm */])({ formId: formId, type: 1 });
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["g" /* setStorage */])('currentTaskId', parseInt(key));
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["g" /* setStorage */])('state', 'history');
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["f" /* jumpTo */])('../simpleTask/simpleTask');
    }
  },
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_history_vue__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_089f41f2_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_history_vue__ = __webpack_require__(200);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_history_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_089f41f2_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_history_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-089f41f2", Component.options)
  } else {
    hotAPI.reload("data-v-089f41f2", Component.options)
  }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('form', {
    ...
    attrs: {
      "src": _vm.hasFinished ? _vm.tagUrl.finished : _vm.tagUrl.unfinished
    }
  })])])])], 1)
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-089f41f2", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "history-task"
  }, [_c('div', [(_vm.taskList !== undefined && _vm.taskList.length === 0) ? _c('div', {
    staticStyle: {
      "color": "#997625",
      "position": "absolute",
      "top": "50%",
  ...
  }, [_vm._v("小主，这里是空的。")]) : _vm._e(), _vm._v(" "), _vm._l((_vm.taskList), function(task, index) {
    return _c('history', {
      key: task.groupId,
      attrs: {
        "taskName": task.title,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1bd2d450", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_1bd2d450_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(202);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_1bd2d450_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1bd2d450", Component.options)
  } else {
    hotAPI.reload("data-v-1bd2d450", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
