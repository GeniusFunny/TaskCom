...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_infoitem__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_simpleTaskList__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_avatarList__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_formButton__ = __webpack_require__(42);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    infoItem: __WEBPACK_IMPORTED_MODULE_4__components_infoitem__["a" /* default */],
    taskList: __WEBPACK_IMPORTED_MODULE_5__components_simpleTaskList__["a" /* default */],
    avatarList: __WEBPACK_IMPORTED_MODULE_6__components_avatarList__["a" /* default */],
    formButton: __WEBPACK_IMPORTED_MODULE_7__components_formButton__["a" /* default */]
  },
  methods: {
    loadTaskList: function loadTaskList() {
      var _this = this;

      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["c" /* showLoading */])();
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__api_API__["d" /* GetSimpleTaskInfo */])(this.info.groupId).then(function (res) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["d" /* hideLoading */])();
        var endTime = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_utils__["a" /* normalizeTimeHours */])(res.data.summary.endTime).split(' ');
        var startTime = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_utils__["a" /* normalizeTimeHours */])(res.data.summary.startTime).split(' ');
        _this.info.date.value = startTime[0] + ' ~ ' + endTime[0];
        _this.info.time.value = startTime[1] + ' ~ ' + endTime[1];
        _this.info.title.value = res.data.summary.title;
        _this.info.TaskList = res.data.items;
        _this.info.isPublic = false;
        if (typeof res.data.members !== 'undefined') {
          _this.info.isPublic = true;
          _this.info.avatarList = res.data.members.map(function (item) {
          ...
          if (_this.info.avatarList.findIndex(function (item) {
            return item.userId === __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["a" /* getStorage */])('userId');
          }) !== -1) {
            _this.hasJoined = true;
            _this.buttonContent = '已加入';
            if (_this.fromShareAndHasJoined && _this.hasJoined || _this.share && !_this.inApp) {
              _this.buttonContent = '返回个人中心';
            }
          }
        }
      }).catch(function (err) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["d" /* hideLoading */])();
        setTimeout(function () {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["e" /* toast */])('网络状况差', 'none');
        }, 1000);
      });
    },
    joinTaskGroup: function joinTaskGroup() {
      var _this2 = this;
      ...
      this.canClick = false;
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__api_API__["e" /* JoinTaskGroup */])(this.info.groupId).then(function (res) {
        _this2.canClick = true;
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__api_API__["f" /* SubmitForm */])({ groupId: _this2.info.groupId, formId: _this2.formId, type: 0 }).then(function (res) {
          console.log(res);
        }).catch(function (err) {
          console.log(err);
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["e" /* toast */])('消息推送失败', 'none');
        });
        _this2.loadTaskList();
      }).catch(function (err) {
        _this2.canClick = true;
        ...
        if (code === 1) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["e" /* toast */])('人数已满: )', 'none');
        } else if (code === 2) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["e" /* toast */])('任务组已经结束: )', 'none');
        } else if (code === 3) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["e" /* toast */])('你已在当前任务组: )', 'none');
        } else if (code === 4) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["e" /* toast */])('单人任务: )', 'none');
        } else if (code === undefined) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["b" /* modal */])('提示', '您尚未注册，是否前往注册？').then(function (res) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["f" /* jumpTo */])('../index/index');
          });
        }
        if (!_this2.inApp) {
          setTimeout(function () {
  ...
  onLoad: function onLoad() {
    this.info.groupId = '';
    this.share = false;
    this.info.groupId = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_wxUtils__["a" /* getStorage */])('currentTaskId') || 0;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_simpleTaskList_vue__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_21cbc572_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_simpleTaskList_vue__ = __webpack_require__(204);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_simpleTaskList_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_21cbc572_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_simpleTaskList_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/simpleTaskList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] simpleTaskList.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21cbc572", Component.options)
  } else {
    hotAPI.reload("data-v-21cbc572", Component.options)
  }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    staticClass: "task",
    class: [!_vm.share ? 'task-fullScreen' : '']
  }, [_c('infoItem', {
    attrs: {
      "name": _vm.info.title.name,
      "value": _vm.info.title.value,
      "mpcomid": '0'
    }
  }), _vm._v(" "), _c('infoItem', {
    attrs: {
      "name": _vm.info.date.name,
      "value": _vm.info.date.value,
      "mpcomid": '1'
    }
  }), _vm._v(" "), _c('infoItem', {
    attrs: {
      "name": _vm.info.time.name,
      "value": _vm.info.time.value,
      "mpcomid": '2'
    }
  }), _vm._v(" "), _c('taskList', {
    attrs: {
      "taskList": _vm.info.TaskList,
      "mpcomid": '3'
    }
  }), _vm._v(" "), (_vm.info.isPublic) ? _c('avatarList', {
    attrs: {
      "avatarList": _vm.info.avatarList,
      "mpcomid": '4',
      "mpcomid": '5'
    }
  }) : _vm._e()], 1), _vm._v(" "), (_vm.share !== undefined && _vm.share) ? _c('div', {
    staticClass: "tc-button"
  }, [_c('formButton', {
    attrs: {
      "button-content": _vm.buttonContent,
      "active": _vm.canClick,
      "eventid": '0',
      "mpcomid": '6',
      "eventid": '1',
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1412911e", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "tc-taskList"
  }, [_vm._m(0), _vm._v(" "), _c('div', {
    staticClass: "tc-taskList-body"
  }, _vm._l((_vm.taskList), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: "tc-taskList-body-item"
    }, [_c('img', {
      staticClass: "tc-taskList-body-item-tag",
      attrs: {
        "src": "/static/images/pending.png",
        "id": item.itemId
      }
    }), _vm._v(" "), _c('div', {
      staticClass: "tc-taskList-body-item-value"
    }, [_vm._v(_vm._s(item.content))])])
  }))])
}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "tc-taskList-tag"
  }, [_c('img', {
    attrs: {
      "src": "/static/images/taskList.png"
    }
  })])
}]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-21cbc572", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_avatarList_vue__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_43ce5cf4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_avatarList_vue__ = __webpack_require__(46);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_avatarList_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_43ce5cf4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_avatarList_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/avatarList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] avatarList.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-43ce5cf4", Component.options)
  } else {
    hotAPI.reload("data-v-43ce5cf4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_infoitem_vue__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_0da16744_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_infoitem_vue__ = __webpack_require__(44);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_infoitem_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_0da16744_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_infoitem_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/infoitem.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0da16744", Component.options)
  } else {
    hotAPI.reload("data-v-0da16744", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "tc-infoItem"
  }, [_c('div', [_vm._v(_vm._s(_vm.name))]), _vm._v(" "), _c('div', {
    staticClass: "tc-infoItem-value"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0da16744", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "tc-avatarList-title"
  }, [_vm._v("参与人员")]), _vm._v(" "), _c('div', {
    staticClass: "tc-avatarList-body"
  }, _vm._l((_vm.avatarList), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: "tc-avatarList-body-item"
    }, [_c('img', {
      class: [_vm.currentUser === item.userId ? 'tc-avatarList-body-item-active' : ''],
      attrs: {
        "src": item.avatar,
        "id": item.userId
      }
    }), _vm._v(" "), _c('div', {
      staticClass: "tc-avatarList-body-item-name"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-43ce5cf4", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_1412911e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(201);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_1412911e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/pages/simpleTask/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1412911e", Component.options)
  } else {
    hotAPI.reload("data-v-1412911e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
