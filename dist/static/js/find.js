...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_tabFind__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_rankItem__ = __webpack_require__(190);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    tab: __WEBPACK_IMPORTED_MODULE_1__components_tabFind__["a" /* default */],
    rankItem: __WEBPACK_IMPORTED_MODULE_2__components_rankItem__["a" /* default */]
  },
  methods: {
    ...
    getRank: function getRank() {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__api_API__["n" /* GetRank */])(page).then(function (res) {
        _this.rankPageSum = res.data.pageSum;
        _this.rankPage++;
        _this.rankList.top3 = res.data.rank.slice(0, 3);
        if (res.data.rank.length >= 3) {
          _this.rankList.rest = res.data.rank.slice(3, res.data.rank.length);
        }
      });
    },
    getVillageTask: function getVillageTask() {
      var _this2 = this;

      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__api_API__["o" /* GetTaskVillage */])().then(function (res) {
        _this2.villageTaskList = res.data.items.map(function (item) {
    ...
    getTaskMoreInfo: function getTaskMoreInfo(e) {
      if (e.target.id) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["f" /* jumpTo */])('../simpleTask/simpleTask?groupId=' + e.target.id + '&share=true&inApp=true');
      }
    },
    touchEventStart: function touchEventStart(e) {
      this.touch.touchDot = e.pageX;
    },
    touchEventMove: function touchEventMove(e) {
      if (Math.abs(this.touch.touchDot - e.pageX) > 120 && !this.touch.refresh) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["c" /* showLoading */])('更新任务村ing');
    ...
    touchEventEnd: function touchEventEnd(e) {
      console.log('滑动结束');
  ...
  onReachBottom: function onReachBottom() {
    ...
    if (this.info.type === 'rank') {
      if (this.rankPage <= this.rankPageSum && this.rankPage <= 10) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["c" /* showLoading */])('加载更多伙伴');
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__api_API__["n" /* GetRank */])(this.rankPage).then(function (res) {
          if (_this3.rankPage === 10 && res.data.rank.length === 10) {
            res.data.rank.pop();
          }
          _this3.rankPage++;
          _this3.rankPageSum = res.data.pageSum;
          _this3.rankList.rest = _this3.rankList.rest.concat(res.data.rank);
          setTimeout(function () {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_wxUtils__["d" /* hideLoading */])();
          }, 700);
        });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_rankItem_vue__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_03e539fc_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_rankItem_vue__ = __webpack_require__(199);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_rankItem_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_03e539fc_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_rankItem_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/rankItem.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] rankItem.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-03e539fc", Component.options)
  } else {
    hotAPI.reload("data-v-03e539fc", Component.options)
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_tabFind_vue__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_e889d73e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_tabFind_vue__ = __webpack_require__(224);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_tabFind_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_e889d73e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_tabFind_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/tabFind.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] tabFind.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e889d73e", Component.options)
  } else {
    hotAPI.reload("data-v-e889d73e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "tc-rankItem-top3"
  }, [_c('img', {
    staticClass: "tc-rankItem-top3-tag",
    attrs: {
      "src": _vm.tagList[_vm.position]
    }
  }), _vm._v(" "), _c('img', {
    staticClass: "tc-rankItem-top3-avatar",
    attrs: {
      "src": _vm.avatar
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "tc-rankItem-top3-name"
  }, [_vm._v(_vm._s(_vm.username))]), _vm._v(" "), _c('div', {
    staticClass: "tc-rankItem-top3-score"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-03e539fc", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "hidden": _vm.info.type !== undefined && _vm.info.type === 'village'
    }
  }, _vm._l((_vm.rankList.top3), function(item, index) {
    return _c('rankItem', {
      key: index,
      attrs: {
        "username": item.username,
        "score": item.peopleScore,
        "position": index + 1,
        "avatar": item.avatar,
        "mpcomid": '1-' + index
      }
    ...
    staticClass: "find-restRank",
    attrs: {
      "hidden": _vm.info.type !== undefined && _vm.info.type === 'village'
    }
  }, _vm._l((_vm.rankList.rest), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: "find-restRank-item"
    }, [_c('div', {
      staticClass: "find-restRank-item-position"
    }, [_vm._v(_vm._s(index + 4))]), _vm._v(" "), _c('img', {
      staticClass: "find-restRank-item-avatar",
      attrs: {
        "src": item.avatar
      }
    }), _vm._v(" "), _c('div', {
      staticClass: "find-restRank-item-name"
    }, [_vm._v(_vm._s(item.username))]), _vm._v(" "), _c('div', {
      staticClass: "find-restRank-item-score"
    }, [_vm._v(_vm._s(item.peopleScore))])])
  })), _vm._v(" "), _c('div', {
    staticClass: "find-village",
    attrs: {
      "hidden": _vm.info.type !== 'village',
      "eventid": '1'
    },
    on: {
      "click": _vm.getTaskMoreInfo
    }
  }, [_c('div', {
    staticStyle: {
      "text-align": "center",
  ...
  }, [_vm._v("每次下拉都有不同的体验")]), _vm._v(" "), _vm._l((_vm.villageTaskList), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: "find-village-item"
    }, [_c('div', {
      staticClass: "find-village-item-tag"
    }, [_c('img', {
      attrs: {
        "src": item.sponsorAvatar
      }
    }), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.sponsorName))]), _vm._v(" "), _c('div', {
      staticStyle: {
        "position": "absolute",
        "right": "35rpx",
        "margin-top": "-32rpx"
      }
    }, [_vm._v("\n          @" + _vm._s(item.sponsorCollage) + "\n        ")])]), _vm._v(" "), _c('div', {
      staticClass: "find-village-item-content",
      attrs: {
        "id": item.groupId
      }
    }, [_c('div', {
      staticClass: "find-village-item-content-title",
      attrs: {
        "id": item.groupId
      }
    }, [_vm._v("\n          " + _vm._s(item.title) + "\n        ")]), _vm._v(" "), _c('div', {
      staticClass: "find-village-item-content-time",
      attrs: {
        "id": item.groupId
      }
    }, [_vm._v("\n          " + _vm._s(item.time) + "\n        ")]), _vm._v(" "), _c('div', {
      staticClass: "find-village-item-content-members"
    }, [(item.members.length > 3) ? _c('div', {
      staticClass: "find-village-item-content-members-count"
    }, [_c('div', [_vm._v("\n              +" + _vm._s(item.members.length - 3) + "\n            ")])]) : _vm._e(), _vm._v(" "), _vm._l((item.members), function(item2, index2) {
      return (index2 <= 2) ? _c('img', {
        key: index2,
        attrs: {
          "src": item2.avatar
        }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5ad16393", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: [
      _vm.type === 'village' ? 'tc-tab-item-active' : ''
    ],
    attrs: {
      "id": "village"
    }
  }, [_vm._v("任务村")]), _vm._v(" "), _c('div', {
    staticClass: "tc-tab-item",
    class: [
      _vm.type === 'rank' ? 'tc-tab-item-active' : ''
    ],
    attrs: {
      "id": "rank"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-e889d73e", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_5ad16393_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(211);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_5ad16393_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5ad16393", Component.options)
  } else {
    hotAPI.reload("data-v-5ad16393", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: {
    ...
    avatar: {
      type: String,
      default: '/static/images/avatar.jpeg'
    },
    tagList: {
      type: Object,
      default: {
        '1': '/static/images/1st.png',
        '2': '/static/images/2th.png',
        '3': '/static/images/3th.png'
      }
    }
  }
});
