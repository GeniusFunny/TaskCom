...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  methods: {
    bindGetUserInfo: function bindGetUserInfo(e) {
      var info = JSON.parse(e.mp.detail.rawData);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["g" /* setStorage */])('nickName', info.nickName);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["g" /* setStorage */])('avatar', info.avatarUrl);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["c" /* showLoading */])();
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["h" /* wxLogin */])().then(function (res) {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_API__["k" /* Login */])(res.code);
      }).then(function (res) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["d" /* hideLoading */])();
        setTimeout(function () {
          if (res.data.isNew) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["f" /* jumpTo */])('../editInfo/editInfo');
          } else {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["f" /* jumpTo */])('../personalCenter/personalCenter');
          }
        }, 500);
      }).catch(function (err) {
        console.error(err);
  ...
  onLoad: function onLoad() {
    ...
    updateManager.onUpdateReady(function () {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["b" /* modal */])('更新提示', '新版本已经准备好，是否重启应用').then(function () {
        updateManager.applyUpdate();
      }).catch(function (err) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_wxUtils__["e" /* toast */])('必须使用新版本', 'none');
        console.log(err);
      });
    });
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-217e574e", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_217e574e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(203);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_217e574e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-217e574e", Component.options)
  } else {
    hotAPI.reload("data-v-217e574e", Component.options)
  }
